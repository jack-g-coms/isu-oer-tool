...
import "@/components/ui/input/tiptap/tiptap-ui-primitive/toolbar/toolbar.scss"
import { cn } from "@/lib/utils/tiptap-utils"
import { useMenuNavigation } from "@/components/ui/input/tiptap/hooks/use-menu-navigation"
import { useComposedRef } from "@/components/ui/input/tiptap/hooks/use-composed-ref"
  ...
  ({ children, className, variant = "fixed", ...props }, ref) => {
    ...
    return (
      <div
        ...
        className={cn("tiptap-toolbar", className, "rounded-t-[8px]")}
        {...props}
      >
        {children}
      </div>
